...
char const    *c_pidfile         = SERVER_PIDFILE;
char const    *c_host            = SERVER_BINDHOST;
int            c_port            = SERVER_PORT;
int            c_log_facility    = SERVER_LOG_FACILITY;
int            c_log_level       = SERVER_LOG_LEVEL;
char const    *c_log_id          = SERVER_LOG_ID;
char const    *c_secret          = SECRET;
size_t         c_secretsize      = SECRETSIZE;
bool           cf_debug          = false;

char const    *c_conffile        = SERVER_STATEDIR "/config.txt";
char const    *c_whitefile       = SERVER_STATEDIR "/whitelist.txt";
char const    *c_greyfile        = SERVER_STATEDIR "/greyfile.txt";
char const    *c_dumpfile        = SERVER_STATEDIR "/dump.txt";
char const    *c_iplistfile      = SERVER_STATEDIR "/iplist.txt";
char const    *c_tofile          = SERVER_STATEDIR "/to.txt";
char const    *c_todfile         = SERVER_STATEDIR "/to-domain.txt";
char const    *c_fromfile        = SERVER_STATEDIR "/from.txt";
char const    *c_fromdfile       = SERVER_STATEDIR "/from-domain.txt";
